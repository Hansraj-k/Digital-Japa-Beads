...
// Function to show an image change menu on right-click (desktop) or long press (mobile)
function showImageChangeMenu(event) {
    event.preventDefault(); // Prevent the default context menu or long press behavior
...
document.getElementById('round-image').addEventListener('touchend', function () {
    clearTimeout(this.touchTimer); // Clear the timeout if the touch is released early
});
